...
export const BY_BRAND_CATEGORIES = [
  ...
  { id: 'dlexo', label: "D'LEXO", slug: 'dlexo' },
  { id: 'reden', label: 'r:Eden', slug: 'reden' },
];

interface ByBrandFilterBarProps {
  searchQuery: string;
  setSearchQuery: (query: string) => void;
  selectedBrandSlug: string;
  setSelectedBrandSlug: (slug: string) => void;
...
export default function ByBrandFilterBar({
  searchQuery,
  setSearchQuery,
  selectedBrandSlug,
