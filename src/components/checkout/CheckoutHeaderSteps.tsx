...
export default function CheckoutHeaderSteps() {
  return (
    <>
          ...
          <div className="space-y-3">
            ...
            <ScrollReveal variant="slide-left" delay={300} duration={800}>
              <p className="font-body text-slate-600 text-sm sm:text-base max-w-[55ch] leading-relaxed">
                Provide your clinic delivery details and select a preferred payment method to finalize your medical cosmetics order.
              </p>
            </ScrollReveal>
          </div>
        </div>
      ...
      {/* Chevron Ribbon Step Indicator Bar (Step 2 Active) */}
