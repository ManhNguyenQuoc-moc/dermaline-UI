...
export default function ProductsHero({ totalCount }: ProductsHeroProps) {
  return (
          ...
          <div className="space-y-3">
            ...
            <ScrollReveal variant="slide-left" delay={300} duration={800}>
              <p className="font-body text-slate-600 text-sm sm:text-base max-w-[55ch] leading-relaxed">
                Hospital-proven derma-cosmetics engineered with 99.5% pure Salmon PDRN and Bio-Exosomes for fundamental skin recovery.
              </p>
            </ScrollReveal>
          </div>
